...
export const COMMANDS: CommandSpec[] = [
  ...
  { name: "/sessions", usage: "/sessions", aliases: [], group: "inspect", description: "Show recent durable sessions" },
  { name: "/session", usage: "/session <id>", aliases: [], group: "inspect", description: "Show a durable session summary", takesValue: true },
  { name: "/search", usage: "/search <query>", aliases: [], group: "inspect", description: "Search current transcript", takesValue: true },
  { name: "/history", usage: "/history <query>", aliases: [], group: "inspect", description: "Search durable sessions", takesValue: true },
  ...
  { name: "/resume", usage: "/resume <id> <instruction>", aliases: [], group: "run", description: "Resume from a durable session", takesValue: true },
  { name: "/fork", usage: "/fork <id> <instruction>", aliases: [], group: "run", description: "Fork from a durable session", takesValue: true },
