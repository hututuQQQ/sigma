...
export const SIGMA_CONFIG_SCHEMA: readonly ConfigField[] = [
  ...
  { key: "maxModelRetries", flag: "max-model-retries", env: "SIGMA_MAX_MODEL_RETRIES", toml: "runtime.max_model_retries", description: "Maximum model request retries", defaultValue: 4, parse: (raw) => numberValue(raw, "maxModelRetries", 0, 10) },
