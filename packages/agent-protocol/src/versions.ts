...
export const LEGACY_STORE_LAYOUT_VERSION_V2 = 2 as const;
export const LEGACY_EVENT_SCHEMA_VERSION_V2 = 2 as const;
export const LEGACY_SNAPSHOT_SCHEMA_VERSION_V2 = 2 as const;
export const LEGACY_KERNEL_STATE_VERSION_V2 = 2 as const;
