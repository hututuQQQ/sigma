...
function runImage(image, archivePath) {
  ...
  const command = [
    ...
    "/opt/sigma/bin/agent doctor --workspace /sigma-work/workspace --provider deepseek --model deepseek-v4-pro --json --strict >/sigma-work/doctor.json || { cat /sigma-work/doctor.json >&2; exit 1; }",
