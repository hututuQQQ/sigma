  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        "packages/agent-store/src/legacy-v2-store.ts": { branches: 95 },
        "packages/agent-store/src/migration-semantics.ts": { branches: 95 },
        "packages/agent-store/src/migration-staging.ts": { branches: 95 },
        "packages/agent-store/src/migration.ts": { branches: 95 },
